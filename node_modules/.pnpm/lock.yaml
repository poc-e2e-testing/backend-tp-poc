...
importers:
  ...
  .:
    ...
    devDependencies:
      ...
      vitest:
        specifier: ^3.1.1
        version: 3.1.1(@types/node@20.12.11)
...
packages:
  ...
  cloudinary@2.6.0:
    resolution: {integrity: sha512-FIlny9RR5LPgkMioG4V7yUpC6ASyIFQMWfx4TgOi/xBeLxJTegbyQc3itiXL0b0lDlSaL0KyT2THEw6osrKqpQ==}
    engines: {node: '>=9'}
...
snapshots:
  ...
  '@vitest/mocker@3.1.1(vite@6.3.0(@types/node@20.12.11))':
    dependencies:
      '@vitest/spy': 3.1.1
      estree-walker: 3.0.3
      magic-string: 0.30.17
    optionalDependencies:
      vite: 6.3.0(@types/node@20.12.11)
  ...
  vite-node@3.1.1(@types/node@20.12.11):
    dependencies:
      cac: 6.7.14
      debug: 4.4.0
      es-module-lexer: 1.6.0
  ...
  vitest@3.1.1(@types/node@20.12.11):
    dependencies:
      '@vitest/expect': 3.1.1
      '@vitest/mocker': 3.1.1(vite@6.3.0(@types/node@20.12.11))
      '@vitest/pretty-format': 3.1.1
